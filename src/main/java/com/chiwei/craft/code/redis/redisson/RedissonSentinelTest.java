...
public class RedissonSentinelTest {
	...
	public static void main(String[] args) {
		...
		config.useSentinelServers().setMasterName(masterName).setPassword("cmcc2019").addSentinelAddress(
				"redis://172.28.72.104:28379", "redis://172.28.72.124:28380", "redis://172.28.72.124:28381");
